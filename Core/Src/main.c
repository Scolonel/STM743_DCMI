    ...
    void StartRunFirst(unsigned AddIndx) //
    {
      ...
      // восстановим частоту - так на всякий случай
       ...
       case 0: //0.5 2.0 km - 33.3nS*700=24uS = Тнак (прореживание = 4)
         ...
         TIM5->CCR4 = 400; //через 1.666 мкС + 42 мкС(сумм 700) меньше 105 мкС
         TIM5->ARR = 401;
         break;
       case 1: //4 km - 33.3nS*1400=47uS = Тнак (прореживание = 4)
         ...
         //TIM4->PSC = 0;
         //TIM4->ARR = TIM4->CCR4 + (8+1)*2;
         TIM5->CCR4 = 400; //через 1.666 мкС + 84 мкС(сумм 1400) меньше 100 мкС
         TIM5->ARR = 401;
         break;
       case 2: //8 km - 33.3nS*2800=94uS = Тнак (прореживание = 2)
         ...
         //TIM4->PSC = 0;
         //TIM4->ARR = TIM4->CCR4 + (8+1)*2;
         TIM5->CCR4 = 5; // +168 мкС (сумм 2800) меньше 200мкС
         TIM5->ARR = 6;
         break;
       case 3: //16 km - 186uS 33.3nS*5600=186uS  = Тнак время накопления
         ...
         //TIM4->PSC = 0;
         //TIM4->ARR = TIM4->CCR4 + (8+1)*2;
         TIM5->CCR4 = 400; // через 1.666 мкС + 336 мкС (сумм 5600) меньше  350мкс
         TIM5->ARR = 401;
         break;
