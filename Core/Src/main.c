  ...
  //TIM12->CNT = 0;
   ...
   // Запуск текущего накопления , параметры должны быть установленны заранее
    ...
    void CreateNextAvrg(void)
    {
      ...
      // при Х/2 - сдвиг на 2
      // 
      g_CountDMA = ((ShFtAv[SumNumNak&0x7f])&(NumRepit-1));
    ...
    void StartRunFirst(unsigned AddIndx) //
    {
      ...
      // восстановим частоту - так на всякий случай
       ...
       case 0: //0.5 2.0 km - 33.3nS*700=24uS = Тнак (прореживание = 8)
         ...
         TIM5->CCR4 = 6; //через 1.666 мкС + 42 мкС(сумм 700) меньше 105 мкС
         TIM5->ARR = 7;
         break;
       ...
       case 6: //128km - 1300uS 266.6нС *5600=1493uS = Тнак
         ...
         //TIM4->PSC = 7;
         //TIM4->ARR = 64;
         TIM5->CCR4 = 360000;//288000;//240*1200;1493 мкС < через 1200 мкС + 336 мкС (сумм 5600) < 1493 мкС
