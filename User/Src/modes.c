...
//    NEX_Transmit((void*)Str);    //
    ...
    {
    sprintf(Str, "t15.txt=\"---\"яяя" ); // < длина линии>
    NEX_Transmit((void*)Str);    //
    sprintf(Str, "t16.txt=\"---\"яяя"); // < длина волны >
    NEX_Transmit((void*)Str);    //
    sprintf(Str, "t17.txt=\"---\"яяя"); // < длительность импульса >
    NEX_Transmit((void*)Str);    //
    sprintf(Str, "t18.txt=\"---\"яяя"); // < коэфф преломления... >
    NEX_Transmit((void*)Str);    //
    ...
    sprintf(Str, "t15.txt=\"%d km\"яяя", (int)(FixParams.ARD/1000.)); // < длина линии>
    NEX_Transmit((void*)Str);    //
    sprintf(Str, "t16.txt=\"%d nm\"яяя", FixParams.AW); // < длина волны >
    NEX_Transmit((void*)Str);    //
    //    sprintf(Str, "t17.txt=\"%d\"яяя", F_SOR.NPPW); // < число точек >
    //NEX_Transmit((void*)Str);    //
    sprintf(Str, "t17.txt=\"%d ns\"яяя", FixParams.PWU); // < длительность импульса >
    NEX_Transmit((void*)Str);    //
    //sprintf(Str, "t18.txt=\"%d\"яяя", F_SOR.AR); // < какой файл выбран >
    //sprintf(Str, "t18.txt=\"%d\"яяя", F_SOR.NAV); // < число накоплений >
    //sprintf(Str, "t18.txt=\"%d\"яяя", F_SOR.AR); // < длина измеряемого участка... >
    sprintf(Str, "t18.txt=\"%.5f\"яяя", FixParams.GI/100000.); // < коэфф преломления... >
    NEX_Transmit((void*)Str);    //
